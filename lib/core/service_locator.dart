...
import 'package:flutter_project/features/movies/data/repository/movies_repository.dart';
...
import 'package:flutter_project/features/tv/data/repository/tv_repository.dart';
...
//repositories
  serviceLocator.registerFactory<TvRepository>(() => TvRepositoryImpl());
//usecase
  serviceLocator.registerFactory<GetTv>(() => GetTv());
  serviceLocator.registerFactory<GetTvReview>(() => GetTvReview());

  //datasource
  serviceLocator
      .registerFactory<TvRemoteDataSource>(() => TvRemoteDataSourceImpl());

  //Movie

//repositories
  serviceLocator
      .registerFactory<MoviesRepository>(() => MoviesRepositoryImpl());
//usecase
  serviceLocator.registerFactory<GetMovies>(() => GetMovies());
  serviceLocator.registerFactory<GetMovieReview>(() => GetMovieReview());
